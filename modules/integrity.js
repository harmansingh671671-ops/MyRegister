...
export function renderIntegrityPanel(container) {
  ...
  container.innerHTML = `
    <div class="integrity-simulator-card card-3d">
      <div class="integrity-header" style="margin-bottom: 12px;">
      ...
      <div class="integrity-grid">
        ...
        <div class="integrity-subcard card-3d" id="focus-sim-box" style="display: flex; flex-direction: column; justify-content: space-between; min-height: 120px;">
          <h4>📴 Screen-Off Focus</h4>
          <div class="sim-timer-display" id="sim-timer-val" style="margin: 4px 0;">00:15</div>
          <button class="btn btn-primary btn-3d btn-full btn-xs" id="start-focus-sim-btn">Start 15s Focus</button>
        </div>

        <!-- 2. Step Goal Sync -->
        <div class="integrity-subcard card-3d" style="display: flex; flex-direction: column; justify-content: space-between; min-height: 120px;">
          <h4>🏃 Fitness Step Sync</h4>
          <div style="margin: 6px 0; display:flex; flex-direction:column; gap:6px;">
            <input type="number" id="sim-steps-input" value="8200" style="width:100%; text-align:center; padding: 4px 0; font-size:12px;" placeholder="Steps">
            <button class="btn btn-secondary btn-3d btn-full btn-xs" id="sync-steps-btn">Sync Steps</button>
          </div>
          <p class="hint" style="margin: 0; font-size:9px; color:var(--text-hint); text-align:center;">Target: 5k (+10 XP) | 10k (+25 XP, +2 💎)</p>
        </div>

        <!-- 3. Morning Alarm check -->
        <div class="integrity-subcard card-3d" style="grid-column: span 2;">
          ...
          <div style="margin-top:8px; display:flex; flex-direction:column; gap:8px;">
            ...
            <button class="btn btn-secondary btn-3d btn-full btn-sm" id="check-alarm-btn">Verify Alarm Alignment</button>
          </div>
        </div>
